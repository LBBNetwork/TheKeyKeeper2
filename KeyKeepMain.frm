...
Begin VB.Form frmMain 
   ...
   Begin VB.Menu usrkey 
      Caption         =   "&User Keys"
      Begin VB.Menu KeyAdd 
         Caption         =   "A&dd new key"
      End
      Begin VB.Menu abar 
         Caption         =   "-"
      End
      Begin VB.Menu Keyview 
         Caption         =   "V&iew your keys"
      End
   End
...
Private Sub Buildbox_Change()
 ShowKeys
End Sub

Private Sub KeyAdd_Click()
 MsgBox "KeyAdd", vbInformation, "KeyAdd"
End Sub

Private Sub Keyview_Click()
  MsgBox "Keyview", vbInformation, "Keyview"
End Sub
